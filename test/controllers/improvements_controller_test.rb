...
class ImprovementsControllerTest < ActionController::TestCase
  ...
  test "should create improvement" do
    assert_difference('Improvement.count') do
      post :create, improvement: { category: @improvement.category, content: @improvement.content, title: @improvement.title, user_id: @improvement.user_id }
    end
  ...
  test "should update improvement" do
    patch :update, id: @improvement, improvement: { category: @improvement.category, content: @improvement.content, title: @improvement.title, user_id: @improvement.user_id }
    assert_redirected_to improvement_path(assigns(:improvement))
  end
